# Powered By @Good_friend_12 @internet_world_M
...
OWNER_ID = list(map(int, getenv("OWNER_ID","6132670595").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Good_Friend_12")
SUPPORT_GROUP = getenv("SUPPORT_GROUP","https://t.me/Good_Friend_12")
